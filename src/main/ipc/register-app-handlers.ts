...
export function registerAppHandlers(
  ...
  ipcMain.handle(ipcChannels.appSendTerminalMessage, (_event, input: unknown) =>
    invokeSafely(() => brainstorm.sendTerminalMessage(input)),
  );
  ...
  return () => {
    ...
    ipcMain.removeHandler(ipcChannels.appSendTerminalMessage);
